...
@Component({
    templateUrl: 'build/pages/ushqim/ushqim.html'
})
export class UshqimPage {
    item;
    color;
    posts;
    ...
    constructor(params: NavParams, private http: Http, public nav: NavController) {
    ...
    makeGetRequest() {
        this.http.get('http://adresaime.de/json_fooding.php').map(res => res.json()).subscribe(data => {
